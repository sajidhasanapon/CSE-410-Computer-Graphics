...
public:
    ...
    edge(double x, double y_min, double y_max, double m_inv, int id)
    {
        this->x_of_y_min    = x;
        this->y_min         = y_min;
        this->y_max         = y_max;
...
bool compare_edge_on_x(edge &a, edge &b)
{return a.x_of_y_min < b.x_of_y_min;}

bool compare_edge_on_y_min(edge &a, edge &b)
